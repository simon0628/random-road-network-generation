...
STREET_SEGMENT_LENGTH_OFFSET_LIMIT = 50
HIGHWAY_SEGMENT_LENGTH = 1000
HIGHWAY_SEGMENT_LENGTH_OFFSET_LIMIT = 200

# width
STREET_SEGMENT_WIDTH = 3
STREET_SEGMENT_WIDTH_OFFSET_LIMIT = 0
HIGHWAY_SEGMENT_WIDTH = 4
...
HEAT_ACCUMULATE_RATE = 0.003
HEAT_ACCUMULATE_RADIUS = 20
